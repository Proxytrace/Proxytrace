...
public class SqliteIntegrationTests : BaseTest<SqliteTestModule>
{
    ...
    public async Task TestInitialize()
    {
        ...
        _testDbPath = Path.Combine(Path.GetTempPath(), $"proxytrace_test_{Guid.NewGuid()}.db");
    }
...
public class SqliteTestModule : Autofac.Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        var testDbPath = Path.Combine(Path.GetTempPath(), $"proxytrace_sqlite_test_{Guid.NewGuid()}.db");
