  ...
  return (
    <section data-testid="evaluator-attached-panel" className="bg-card rounded-lg shadow-[var(--shadow-card)]">
      <header className="flex items-center gap-2.5 px-4 py-3 border-b border-hairline">
        <span className="text-[10px] text-muted uppercase tracking-[0.09em] font-semibold"><Trans>Attached to</Trans></span>
      ...
      <div className="grid grid-cols-2 gap-[18px] px-4 py-3.5">
        <div>
          <div className="text-[10px] text-muted uppercase tracking-[0.07em] font-semibold mb-2"><Trans>Test suites</Trans></div>
          {suites.length ? (
          ...
          ) : <span className="text-[11px] text-muted"><Trans>Not attached to any suite yet.</Trans></span>}
        </div>
        <div>
          <div className="text-[10px] text-muted uppercase tracking-[0.07em] font-semibold mb-2"><Trans>Agents</Trans></div>
          {agents.length ? (
            <div className="flex flex-col gap-[5px]">
              {agents.map(a => (
                <RowButton
          ...
          ) : <span className="text-[11px] text-muted"><Trans>Not used by any agent yet.</Trans></span>}
        </div>
      </div>
    </section>
  );
