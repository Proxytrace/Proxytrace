...
/**
 * Resolves a Tracey turn's correlation id (its captured call's ConversationId) to the latest
 * matching trace and routes to the Traces detail view. Ingestion is asynchronous, so a freshly
 * sent turn may not be captured yet — that surfaces as an info toast rather than a dead link.
 */
