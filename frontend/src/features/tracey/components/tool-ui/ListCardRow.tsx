...
export function ListCardRow({ to, color, title, subtitle, right }: ListCardRowProps) {
  return (
    <Link
      to={to}
      className="group flex items-center gap-2.5 px-3 py-2 transition-colors duration-[var(--motion-fast)] hover:bg-[var(--bg-wash-hover)] focus-visible:outline-none focus-visible:-outline-offset-2 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[color-mix(in_srgb,var(--accent-primary)_60%,transparent)]"
    >
      {color && (
