...
import { useTracesForSuiteEdit } from './hooks/useTracesForSuiteEdit';
import { lastUserSnippet } from './lib/snippet';
...
export function TestCasesPanel({
  ...
  const { data: tracesData, isLoading: tracesLoading } = useTracesForSuiteEdit(agentId, sub === 'add');
