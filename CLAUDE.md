...
| [`docs/licensing.md`](docs/licensing.md) | Touching the Enterprise support-key subsystem (`ILicenseService`, key activation) — nothing is feature-gated |
...
| [`docs/ci.md`](docs/ci.md) | Adding a CI job/workflow, or touching path gating or a build cache |
