...
- **Key metrics** — high-level counters and rates across your captured traffic and test
  runs.
- **Time-range selector** — choose the window (last hour, 24 hours, 7 days, or 30 days)
  that all metrics are computed over. Your choice is remembered in your browser, so it
